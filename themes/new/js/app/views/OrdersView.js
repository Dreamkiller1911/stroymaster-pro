...
function OrdersView() {
    ...
    this.viewFormCreate = function () {
        var _this = this;
        var formatter = document.createElement('script');
        formatter.src = '/themes/new/js/app/elements/digitalBush-jquery.maskedinput-9672630/dist/jquery.maskedinput.min.js';
        formatter.onload = function () {
            _this.if(function(){
                this.show({
